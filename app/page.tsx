...
export default function HomePage() {
  ...
  function startGame() {
    ...
    window.localStorage.setItem("eou-v097-setup", JSON.stringify({ leaderName: cleanLeader, houseName: cleanHouse, origin }));
    window.localStorage.removeItem("eou-v097-save");
    router.push("/game");
  }
    ...
    <main className="app start-shell">
      <section className="start-card">
        <article className="panel prologue">
          ...
          <div className="kicker">ZERO START · GUIDED SURVIVAL EDITION</div>
